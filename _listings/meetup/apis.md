...
- name: Meetup
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/albums/master/_listings/meetup/2-photos-ws.md
- name: Meetup Photo Album2
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/albums/master/_listings/meetup/2-photo-album-post.md
x-common:
- type: x-base
